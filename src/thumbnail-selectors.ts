...
export function getThumbnailImageSelectors() {
    if (!onMobile()) {
        ...
        return "img.video-thumbnail-img, img.amsterdam-playlist-thumbnail, ytm-shorts-lockup-view-model img, yt-content-preview-image-view-model img, yt-thumbnail-view-model *:not(.ytThumbnailViewModelBlurredImage) img";
    }
}
